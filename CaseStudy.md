...
## Design Statement
The main goal of the project was to create a product or installation that could possibly be created by yourself or a team. Using a series of different techniques such as brainstorming, body storming, and using a design matrix the project explored many different ways to come up with a product or installation. Like previous projects this brainstorming and discussion was done as a group, but the final product creation was done individually. The case study regarding Studio Roosegaarde was also done as a group as we all unanimously agreed that the aspects and different creations by the studio aligned with what enjoyed creating. Many different products were brainstormed such as a proximity LED mirror and a social distancing wearable. However, while branching off from the idea of social distancing and light the idea of a public space installation was brainstormed. The main product created for this project was a social distancing ring, the DistancRing. Which would mainly be used in high traffic areas such as grocery stores where social distancing rules are necessary. However, because of the pandemic workshopping and labs aren’t available, so the project was mainly worked on with limited materials, and creating mockups that could be shown to possible “investors” that the project could be made a reality.
...
## DistancRing
The DistancRing is mainly to be used in high traffic areas such as grocery stores. Many people who go to grocery stores try their best to keep their distance from other people, but sometimes it might just not be possible, or there are some people who don’t wish to follow social distancing rules. The DistancRing is the solution to that issue. Equipped to any grocery store basket or cart and it will create a light ring that will allow the user to safely social distance. In times where users’ rings might get too close or overlap the colour of the ring will change allowing the users to have a visual cue as to what has happened.<br/> 

Initially the DistancRing was thought to be a floor installation, however realistically thinking would cost too much to put into the floor of every grocery store. Another possible idea was to have it installed on the ceiling of stores, but the technicalities of light following every shopper around in the store would also be hard to create. In the end, the DistancRing would instead be attached to an item that every grocery store shopper would have: a basket or a cart. This way the ring would be able to take note of whether the social distancing bubble would need to only fit a person and a basket, or a person and their cart. 

## Outcomes & Lessons Learned
In the end, a video showcasing the possibility of a new COVID19 social distancing product was created. The main hurdle for the creation of the project was figuring out a way to create the product with limited time and limited resources. Some of the main lessons learned throughout this project were how to improvise and show a product even if it wasn’t possible to build at that moment. Another lesson learned was to take time to step away from projects. Using After Effects to have the ring look like it was following a moving person was a slight challenge due to being inexperienced but taking time with the project allowed a lot of learning and growing.<br/>

lesons that we learned going into the future are how important it is to have visual mockups of a products you plan to create. For this project it was never planned to take the DistancRing any further than just prototyping and mockups. The original main idea for the project was meant to be the wearable, but after getting feedback on the DistancRing it seemed like it would be an interesting challenge to take on. Most of the experience with using After Effects was during projects that mainly handled still imagers, so to use it on a video was something new. The learning curve wasnt any different but it did show that I needed to be attentive to the frame by changes to allow a more realistic flow with the mockup. In future projects with the right materials this project could become a reality, however through using After Effects it came to my attention that this product might not be able to fully to project around entire person, but could instea only project in the front, the back and possibly the side, but not completely around the whole person. 
